        ...
        return (
            <div className="card">
                <form className="admin-form ajouter-recette" onSubmit={this.handleSubmit}>
                    ...
                    <textarea value={this.state.ingredients} onChange={this.handleChange} name={'ingredients'} rows={"3"}
                              placeholder={'Liste des ingredients'}/>
                    <textarea value={this.state.instructions} onChange={this.handleChange} name={'instructions'} rows={'15'}
